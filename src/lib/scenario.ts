  ...
  const memories = [
    {
      ...
      service: "checkout-api",
      title: "Connection pool exhaustion signature",
      content: "Look for timeout spikes, active connections pinned at pool maximum, and sessions missing release calls. Restart is mitigation only.",
